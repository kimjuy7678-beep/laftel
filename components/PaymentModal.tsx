...
function SuccessModal({ plan, onConfirm }: { plan: Plan; onConfirm: () => void }) {
    useEffect(() => {
        // 폭죽 발사!
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div className="bg-[#1a1a1a] rounded-2xl w-full max-w-sm p-10 flex flex-col items-center text-center gap-6 border border-white/10">
                ...
                <div className="w-full rounded-xl p-5 text-left flex flex-col gap-3" style={{ background: `${plan.color}12`, border: `1px solid ${plan.color}40` }}>
...
export default function PaymentModal({ isOpen, onClose, planId }: PaymentModalProps) {
    ...
    return (
        <>
            ...
            >
                ...
                >
                    ...
                    <div className="px-8 py-6 flex flex-col gap-7">
                        ...
                        {/* 유의사항 */}
                        <div className="rounded-xl p-5 bg-white/5 border border-white/10 max-h-36 overflow-y-auto" style={{ scrollbarWidth: 'thin', scrollbarColor: 'rgba(255,255,255,0.1) transparent' }}>
            ...
            {showSuccess && (
                <SuccessModal plan={plan} onConfirm={handleSuccessConfirm} />
            )}
        </>
    )
}