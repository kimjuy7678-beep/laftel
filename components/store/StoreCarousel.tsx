...
const Banners: Banner[] = [
    {
        ...
        content: "코트의 열기를 그대로 ⚡\n최애 선수와 함께하는 공식 굿즈",
        button: "하이큐 굿즈 보러가기",
        href: "/store/series?series=%ED%95%98%EC%9D%B4%ED%81%90",
    },
    {
        ...
        button: "주술회전 굿즈 보러가기",
        href: "/store/series?series=%EC%A3%BC%EC%88%A0%ED%9A%8C%EC%A0%84",
    },
    {
        ...
        button: "미쿠 굿즈 보러가기",
        href: "/store/series?series=%ED%95%98%EC%B8%A0%EB%84%A4%EB%AF%B8%EC%BF%A0",
    },
    {
        ...
        button: "귀멸 굿즈 보러가기",
        href: "/store/series?series=%EA%B7%80%EB%A9%B8%EC%9D%98%20%EC%B9%BC%EB%82%A0",
    },
];
                    ...
                    <div className="min-w-0 flex-1 overflow-hidden rounded-[12px] shadow-[0_8px_30px_rgba(0,0,0,0.2)] sm:rounded-xl">
                        ...
                        >
                            {Banners.map((m, id) => (
                                <SwiperSlide key={id}>
                                    {/* 이미지 + 텍스트 오버레이 */}
                                    <div className="relative aspect-[1369/550] w-full bg-[#111018]">
                                        ...
                                        <div className="absolute inset-0 flex max-w-[92%] flex-col justify-center gap-2 px-6 pb-10 sm:max-w-[620px] sm:gap-3 sm:px-10 sm:pb-0">
                                            ...
                                            <Link href={m.href} className="mt-2 w-fit rounded-full bg-[#826cff] px-4 py-2 text-[12px] font-medium text-white shadow-md transition-colors hover:bg-violet-600 sm:px-5 sm:text-sm">
                                                {m.button}
                                            </Link>
                                        </div>
                                    </div>
