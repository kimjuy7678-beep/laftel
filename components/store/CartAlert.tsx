        ...
        <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/10" onClick={onClose}>
            <div onClick={e => e.stopPropagation()}
                ...
                <div className="relative px-8 pt-7 pb-5 flex flex-col items-center gap-3">
                    ...
                    <span className="rounded-full bg-[#826CFF] px-3 py-1 text-[12px] font-bold text-white">장바구니 담기 완료</span>
                    {thumbnail && (
                        <div
                ...
                <div className="flex border-t border-[#f0edf8]">
                    ...
                    <button onClick={() => { onClose(); router.push("/store/cart"); }}
                        className="flex-1 h-[56px] text-[15px] font-bold text-white bg-[#826CFF] transition hover:bg-[#6552ee]">
                        장바구니로 가기
                    </button>
                </div>
            </div>
