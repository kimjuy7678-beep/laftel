    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/20" onClick={onClose}>
            <div onClick={e => e.stopPropagation()}
                className="w-[560px] rounded-[24px] border border-white/40 bg-white/80 backdrop-blur-[20px] shadow-[0_12px_48px_rgba(120,101,255,0.2)] px-10 py-10 flex flex-col items-center gap-5">
                ...
                <div className="text-center">
                    ...
                    <p className="mt-2 text-[14px] text-[#9b94b2]">3초 뒤에 로그인 페이지로 자동 이동합니다...</p>
                </div>
