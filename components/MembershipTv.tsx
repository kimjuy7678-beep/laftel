    ...
    return (
        <div className="w-full py-20 relative">
            <div className="px-16 2xl:px-32 mb-16 2xl:mb-24">
                <h2 className="text-3xl 2xl:text-5xl font-extrabold mb-6 2xl:mb-10">초고화질로 선명하게 보는 애니메이션</h2>
            ...
            <div className="px-16 2xl:px-32 text-right">
                <h2 className="text-3xl 2xl:text-5xl font-extrabold mb-4 2xl:mb-6 mt-[-250]">
