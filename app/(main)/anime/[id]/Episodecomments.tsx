            ...
            <div className="flex gap-2.5 mb-5">
                ...
                <div className="flex-1 flex gap-2">
                    <input
                        ...
                        className="flex-1 bg-[var(--bg-secondary)] border border-[var(--border)] rounded-lg px-3.5 py-2 text-[13px] text-[var(--text-primary)] placeholder:text-[var(--text-faint)] outline-none focus:border-[#6c63ff]/60 transition-all"
                    />
                    <button
                    ...
                    >
                        {submitting ? <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : '등록'}
                    </button>
                </div>
            </div>
